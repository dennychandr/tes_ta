...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            @guest
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('login') }}">Login for Admin</a>
                </li>
            @else
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item ">
                    @if(Request::is('user'))
                        <a href="{{url('bencana?jenis_bencana=Gunung%20Meletus&lokasi_bencana=JawaTimur&nama_gunung=Kelud&price=0&search=Search&thn_kej=2020#')}}" class="nav-link active">
                            @else
                                <a href="{{url('bencana?jenis_bencana=Gunung%20Meletus&lokasi_bencana=JawaTimur&nama_gunung=Kelud&price=0&search=Search&thn_kej=2020#')}}" class="nav-link">
                                    @endif
